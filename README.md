...
1) Code needs to be open source and easily accessible. (No “lost” code.)
    ...
    ![](https://github.com/Human-Augment-Analytics/Higher-Ed/tree/main/Project-Code/imgs/code_base_1.PNG)
...
2) Code contributions need to be tracked for publication attributions. 
    ...
    ![](https://github.com/Human-Augment-Analytics/Higher-Ed/tree/main/Project-Code/imgs/code_base_2.PNG)
...
3) Code needs to be marked as either: in-progress, tested and documented, or abandoned.
    ...
    ![](https://github.com/Human-Augment-Analytics/Higher-Ed/tree/main/Project-Code/imgs/code_base_3.PNG)
